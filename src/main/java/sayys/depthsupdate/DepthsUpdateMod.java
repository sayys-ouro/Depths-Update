...
import sayys.depthsupdate.block.BlockCavesSlab;
...
public class DepthsUpdateMod {
        ...
        public void construct(@NonNull FMLConstructionEvent event) {
                ...
                assets.put("assets/minecraft/textures/block/deepslate.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/deepslate.png");
                assets.put("assets/minecraft/textures/block/deepslate_top.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/deepslate_top.png");
                assets.put("assets/minecraft/textures/block/cobbled_deepslate.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/cobbled_deepslate.png");
                assets.put("assets/minecraft/textures/block/polished_deepslate.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/polished_deepslate.png");
                assets.put("assets/minecraft/textures/block/deepslate_bricks.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/deepslate_bricks.png");
                assets.put("assets/minecraft/textures/block/deepslate_tiles.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/deepslate_tiles.png");
                assets.put("assets/minecraft/textures/block/chiseled_deepslate.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/chiseled_deepslate.png");
                assets.put("assets/minecraft/textures/block/cracked_deepslate_bricks.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/cracked_deepslate_bricks.png");
                assets.put("assets/minecraft/textures/block/cracked_deepslate_tiles.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/cracked_deepslate_tiles.png");
                assets.put("assets/minecraft/textures/block/calcite.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/calcite.png");
                assets.put("assets/minecraft/textures/block/dripstone_block.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/dripstone_block.png");
                assets.put("assets/minecraft/textures/block/moss_block.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/moss_block.png");
                assets.put("assets/minecraft/textures/block/rooted_dirt.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/rooted_dirt.png");
                assets.put("assets/minecraft/textures/block/tuff.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/tuff.png");
                assets.put("assets/minecraft/textures/block/amethyst_block.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/amethyst_block.png");
                assets.put("assets/minecraft/textures/block/budding_amethyst.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/budding_amethyst.png");
                assets.put("assets/minecraft/textures/block/smooth_basalt.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/smooth_basalt.png");
                assets.put("assets/minecraft/textures/block/raw_iron_block.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/raw_iron_block.png");
                assets.put("assets/minecraft/textures/block/raw_gold_block.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/raw_gold_block.png");
                assets.put("assets/minecraft/textures/block/raw_copper_block.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/raw_copper_block.png");
                assets.put("assets/minecraft/textures/block/azalea_leaves.png",
                                "assets/" + Reference.MOD_ID + "/textures/blocks/azalea_leaves.png");
                assets.put("assets/minecraft/textures/block/flowering_azalea_leaves.png",
        ...
        public static class RegistrationHandler {
                ...
                public static final Block cobbled_deepslate_stairs = new sayys.depthsupdate.block.BlockCavesStairs(
                                "cobbled_deepslate_stairs", cobbled_deepslate.getDefaultState());
                public static final Block polished_deepslate_stairs = new sayys.depthsupdate.block.BlockCavesStairs(
                                "polished_deepslate_stairs", polished_deepslate.getDefaultState());
                public static final Block deepslate_brick_stairs = new sayys.depthsupdate.block.BlockCavesStairs(
                                "deepslate_brick_stairs", deepslate_bricks.getDefaultState());
                public static final Block deepslate_tile_stairs = new sayys.depthsupdate.block.BlockCavesStairs(
                                "deepslate_tile_stairs", deepslate_tiles.getDefaultState());
                public static final Block cobbled_deepslate_wall = new sayys.depthsupdate.block.BlockCavesWall(
                                "cobbled_deepslate_wall", cobbled_deepslate);
                public static final Block polished_deepslate_wall = new sayys.depthsupdate.block.BlockCavesWall(
                                "polished_deepslate_wall", polished_deepslate);
                public static final Block deepslate_brick_wall = new sayys.depthsupdate.block.BlockCavesWall(
                                "deepslate_brick_wall",
                                deepslate_bricks);
                public static final Block deepslate_tile_wall = new sayys.depthsupdate.block.BlockCavesWall(
                                "deepslate_tile_wall",
                                deepslate_tiles);
                ...
                public static final Block azalea_leaves = new sayys.depthsupdate.block.BlockCavesLeaves(
                                "azalea_leaves");
                public static final Block flowering_azalea_leaves = new sayys.depthsupdate.block.BlockCavesLeaves(
                ...
                public static final BlockCavesSlab.Double deepslate_slab_double = new BlockCavesSlab.Double(
                                "deepslate_slab_double", Material.ROCK);
                public static final BlockCavesSlab.Half deepslate_slab_half = new BlockCavesSlab.Half(
                                "deepslate_slab_half",
                ...
                public static void registerItems(RegistryEvent.Register<Item> event) {
                        ...
                        event.getRegistry().register(new sayys.depthsupdate.block.ItemCavesSlab(deepslate_slab_half,
                                        deepslate_slab_half, deepslate_slab_double)
                ...
                public static void registerModels(ModelRegistryEvent event) {
                        ...
                        for (sayys.depthsupdate.block.BlockCavesSlab.Variant variant : sayys.depthsupdate.block.BlockCavesSlab.Variant
                                        .values()) {
